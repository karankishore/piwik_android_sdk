...
public class PiwikDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = "CREATE TABLE " + EVT_TABLE + "(" + EV_TABLE_COL_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + EVT_TABLE_COL_USER_ID + " TEXT, " + EVT_TABLE_COL_INFO + " TEXT, " + EVT_TABLE_COL_EXTRA_INFO + " TEXT, " + EVT_TABLE_COL_TIMESTAMP + " TEXT)";
