...
public interface PiwikDBItems extends BaseColumns {
    ...
    public static final String[] PROJECTION_ALL = {_ID, PiwikDatabaseHelper.EVT_TABLE_COL_USER_ID, PiwikDatabaseHelper.EVT_TABLE_COL_INFO, PiwikDatabaseHelper.EVT_TABLE_COL_TIMESTAMP};
